...
def add_child(G, parent_node, child, color=None, end_node=False):
    ...
    if end_node:
        G.add_node(
            child_x, label=child, width=width_box, shape=leafnde_shape, style='filled', concentrate=True, fillcolor=color,
            fontname=font_name, fontsize=font_size)
    else:
        G.add_node(
            child_x, label=child, width=width_box, shape=subgrp_shape, style='filled', concentrate=True, fillcolor=color,
            fontname=font_name, fontsize=font_size)
...
def gen_figure(dir_list):
    G = pgv.AGraph(
        ...
        nodesep=0.25)
    G.add_node(
        '/', label='ROOT', shape=subgrp_shape, style='filled', concentrate=True, width=width_box,
...
def add_leaf(G, parent, leaf_name, leaf_html):
    G.add_node(
        leaf_name, label=leaf_html, shape='box', style='filled', concentrate=True, width=width_box,
        fontname=font_name, fontsize=font_size, fillcolor=NODE_3)
    G.add_edge(
        parent, leaf_name, weight=1, penwidth=edge_width, arrowsize=0.0, style='dashed',
        arrowhead=None, constraint=True, headport="ne", tailport="nw")
    G.add_edge(
        leaf_name, parent, weight=1, penwidth=edge_width, arrowsize=0.0, style='dashed',
...
tpoints = '<<TABLE ALIGN="CENTER" BORDER="0" CELLBORDER="1" CELLSPACING="0" CELLPADDING="2" FIXEDSIZE="TRUE"> <TR> <TD WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">0/1</TD></TR> <TR> <TD ALIGN="CENTER" WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE">...</TD></TR> <TR><TD ALIGN="CENTER" WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE">99/74</TD></TR></TABLE>>'

tpoints2 = '<<TABLE ALIGN="CENTER" BORDER="0" CELLBORDER="1" CELLSPACING="0" CELLPADDING="2" FIXEDSIZE="TRUE"> <TR> <TD WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE" ALIGN="CENTER">0</TD></TR> <TR> <TD ALIGN="CENTER" WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE">...</TD></TR> <TR><TD ALIGN="CENTER" WIDTH="40" HEIGHT="30" FIXEDSIZE="TRUE">99</TD></TR></TABLE>>'
...
dir_list = ['/map/static/pyrRS23_names',
            '/map/static/nRT_names',
            '/map/uniform/pyrRS23_names',
            '/map/uniform/nRT_names',
            '/map/event/pyrRS23_spikes',
            '/map/event/nRT_spikes']

G = gen_figure(dir_list)
add_leaf(G, dir_list[0], 'map_names', tpoints)
add_leaf(G, dir_list[2], 'map_names2', tpoints)
add_leaf(G, dir_list[4], 'map_spikes', tpoints2)
