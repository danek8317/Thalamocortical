...
if __name__ == '__main__':
    cell_range = [0,100,105,114,123,132,156,236,256,306,316,326,336,346,356]
    ...
    for pop_idx in all_pops: #each population do
        ...
        arr = pd.read_csv('punkty0_small.dat', sep='\t', usecols=[2,3,4,5,6,7,8], 
